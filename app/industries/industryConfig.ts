...
export const industryChapters = [
  {
    ...
    model: {
      ...
      presentation: { scale: 0.92, offset: ["0%", "1%"] },
      framing: {
        modelScale: 1,
        position: [0, 0, 0],
        rotation: [0, -0.32, 0],
        camera: { position: [4.8, 3.1, 6.4], fov: 34 },
      },
  ...
  },
  {
    ...
    model: {
      ...
      presentation: { scale: 0.93, offset: ["0%", "1%"] },
      framing: { camera: { position: [3, 2.05, 4.7], fov: 35 } },
  ...
  },
  {
    ...
    model: {
      ...
      renderOptions: { rotationSpeed: 0.055, steam: true, bloomIntensity: 0.85, environmentPreset: null },
    },
    fallback: { mode: "field" },
  },
